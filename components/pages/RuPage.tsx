            ...
            >
              ...
              <div className={styles.aboutContent}>
                <motion.p variants={{ hidden: { opacity: 0, y: 20, filter: "blur(4px)" }, visible: { opacity: 1, y: 0, filter: "blur(0px)" } }} className={styles.leadParagraph}>
                  ENVI — это премиальная импортно-дистрибьюторская компания, расположенная в Таллине, Эстония.
                </motion.p>
                ...
                <motion.p variants={{ hidden: { opacity: 0, y: 20, filter: "blur(4px)" }, visible: { opacity: 1, y: 0, filter: "blur(0px)" } }} className={styles.bodyText}>
                  Мы предоставляем эксклюзивный доступ к исключительным международным брендам в сфере <span className={styles.highlight}>гурмэ-продуктов, элитных вин и профессиональной косметики</span>. ENVI строит долгосрочные стратегические партнерства с дальновидными производителями, предлагая беспрепятственный выход на рынки Балтии и Европы: от логистики и таможенного оформления до премиального маркетинга и развития каналов продаж.
                </motion.p>
                <motion.p variants={{ hidden: { opacity: 0, y: 20, filter: "blur(4px)" }, visible: { opacity: 1, y: 0, filter: "blur(0px)" } }} className={styles.bodyText}>
                  Из Таллина — динамичного европейского центра — мы гарантируем высочайшие стандарты качества, эксклюзивности и точности.
                </motion.p>
              </div>
            </motion.div>
          </div>
            ...
            <div className={styles.editorialGrid}>
              ...
              >
                ...
                <motion.p variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className={styles.leadParagraph}>
                  Итальянское дерматокосметическое совершенство, подкрепленное более чем 40 годами научных исследований.
                </motion.p>
                <motion.p variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className={styles.bodyText}>
                  Инновационные формулы регенерируют, балансируют и оживляют кожу, используя растительные стволовые клетки и биостимуляцию кожи. Идеально для профессионалов, оно предлагает передовые процедуры, которые превращают даже чувствительную и поврежденную кожу в ее самое здоровое и сияющее состояние.
                </motion.p>
              </motion.div>
            </div>
          </div>
